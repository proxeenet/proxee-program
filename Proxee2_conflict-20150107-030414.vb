...
Public Class Proxee
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmboProxyAddresses.Items.Add("sanjose.proxee.net:1342")
        cmboProxyAddresses.Items.Add("sanjose2.proxee.net:1442")
        ...
        cmboProxyAddresses.Items.Add("montreal2.proxee.net:1433")
        cmboProxyAddresses.Items.Add("netherlands.proxee.net:3659")
        cmboProxyAddresses.Items.Add("romania.proxee.net:2015")
    ...
    Private Sub Timer1_Tick_2(sender As Object, e As EventArgs) Handles tmrCheckSkype.Tick
        ...
        If Process.GetProcessesByName("Skype").Length <> 0 Then
            ...
            tmrCheckSkype.Enabled = False
        Else
            stripStatusLabel.Text = "Error: Unable to find Skype - check options"
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        rp(8) = ping.Send("sanjose.proxee.net")
        rp(9) = ping.Send("sanjose2.proxee.net")
        rp(10) = ping.Send("la.proxee.net")
        rp(11) = ping.Send("la2.proxee.net")
        rp(12) = ping.Send("chicago.proxee.net")
        rp(13) = ping.Send("chicago2.proxee.net")
        rp(14) = ping.Send("frankfurt.proxee.net")
        rp(15) = ping.Send("montreal.proxee.net")
        rp(16) = ping.Send("montreal2.proxee.net")
        rp(17) = ping.Send("netherlands.proxee.net")
        rp(18) = ping.Send("romania.proxee.net")
    End Sub

    Private Sub BackgroundWorker1_RunWorkerCompleted(sender As Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        On Error Resume Next
        lstPing.Items.Add("Atlanta 1 Ping: " & rp(0).RoundtripTime & " ms")
        lstPing.Items.Add("Atlanta 2 Ping: " & rp(1).RoundtripTime & " ms")
        lstPing.Items.Add("Seattle 1 Ping: " & rp(2).RoundtripTime & " ms")
        lstPing.Items.Add("Seattle 2 Ping: " & rp(3).RoundtripTime & " ms")
        lstPing.Items.Add("New York 1 Ping: " & rp(4).RoundtripTime & " ms")
        lstPing.Items.Add("New York 2 Ping: " & rp(5).RoundtripTime & " ms")
        lstPing.Items.Add("Dallas 1 Ping: " & rp(6).RoundtripTime & " ms")
        lstPing.Items.Add("Dallas 2 Ping: " & rp(7).RoundtripTime & " ms")
        lstPing.Items.Add("San Jose 1 Ping: " & rp(8).RoundtripTime & " ms")
        lstPing.Items.Add("San Jose 2 Ping: " & rp(9).RoundtripTime & " ms")
        lstPing.Items.Add("Los Angeles 1 Ping: " & rp(10).RoundtripTime & " ms")
        lstPing.Items.Add("Los Angeles 2 Ping: " & rp(11).RoundtripTime & " ms")
        lstPing.Items.Add("Chicago 1 Ping: " & rp(12).RoundtripTime & " ms")
        lstPing.Items.Add("Chicago 2 Ping: " & rp(13).RoundtripTime & " ms")
        lstPing.Items.Add("Frankfurt 1 Ping: " & rp(14).RoundtripTime & " ms")
        lstPing.Items.Add("Montreal 1 Ping: " & rp(15).RoundtripTime & " ms")
        lstPing.Items.Add("Montreal 2 Ping: " & rp(16).RoundtripTime & " ms")
        lstPing.Items.Add("Netherlands 1 Ping: " & rp(17).RoundtripTime & " ms")
        lstPing.Items.Add("Romania 1 Ping: " & rp(18).RoundtripTime & " ms")
    End Sub

    Private Sub cmdPing_Click(sender As Object, e As EventArgs)
