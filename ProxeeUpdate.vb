...
Module ProxeeUpdate
    Public Sub AutoUpdate()
        ...
        Dim CurrentVersion As String = "v8.0" '--- Change this to Current version, needs changing on every update
        Dim ProgramName As String = "Proxee" '--- Change this to Your Progran Name
        Dim SiteName As String = "https://proxee.net/UpdateCHK.html" '--- Change this to Your Update page (may require https)
        ...
        If GetVer > CurrentVersion Then
            GetUpd = MsgBox("Proxee.net Proxy Program is outdated! " + My.Settings.Username + "" & vbCrLf & "A new update is available and ready to download" & _
            ...
            If GetUpd = vbYes Then
                ...
                If sfd.ShowDialog = DialogResult.OK Then
                    ...
                    MsgBox("Update complete. Please launch the updated version now. If you need your login information, please check https://proxee.net/billing/clientarea.php?action=services")
                    End
